...
public class Camera
{
  ...
  */
  ...
  public Vector2 getScreenSize() {return new Vector2(screenSizeX, screenSizeY);}
  ...
  public void follow() {
    if (target != null) {
      ...
      if (dist.magsquare() >= 0.1)
        position = position.add(dist.multiply(CLOSE_MAGNITUDE));
    }
  }
